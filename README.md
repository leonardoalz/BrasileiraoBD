...
``` A base de dados (BD_Brasileirao.db) pode ser visualizada inteiramente em um software adequado para tal. Para que consiga executar a aplicação, leia o final da página e siga as instruções. ```
<br><br>
